...
// ********************************* Mock Data *********************************
var administratorAffiliationSingle_in = `[{"administratorAffiliationUUID":"85fff2bf-00a2-423b-9567-55c6f4ee6ee1","administrator":"GECKOS!!","startDate":"2018-01-01T21:17:34.371Z","endDate":"2018-12-31T22:27:34.111Z","affiliations":[{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"111111","affiliateName":"test1"},{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"222222","affiliateName":"test2"}]}]`
var administratorAffiliationSingle_out = `{"docType":"ADMINISTRATORAFFILIATION","administratorAffiliationUUID":"85fff2bf-00a2-423b-9567-55c6f4ee6ee1","administrator":"GECKOS!!","startDate":"2018-01-01T21:17:34.371Z","endDate":"2018-12-31T22:27:34.111Z","affiliations":[{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"111111","affiliateName":"test1"},{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"222222","affiliateName":"test2"}]}`

var administratorAffiliationMultiple_in = `[{"administratorAffiliationUUID":"85fff2bf-00a2-423b-9567-55c6f4ee6ee1","administrator":"GECKOS!!","startDate":"2018-01-01T21:17:34.371Z","endDate":"2018-12-31T22:27:34.111Z","affiliations":[{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"111111","affiliateName":"test1"},{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"222222","affiliateName":"test2"}]},{"administratorAffiliationUUID":"817903a5-8a5f-4d51-af47-5bae33fc15b3","administrator":"GECKOS!!","startDate":"2018-01-01T21:17:34.371Z","endDate":"2018-12-31T22:27:34.111Z","affiliations":[{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"111111","affiliateName":"test1"},{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"222222","affiliateName":"test2"}]}]`
var administratorAffiliationMultiple_out1 = `{"docType":"ADMINISTRATORAFFILIATION","administratorAffiliationUUID":"85fff2bf-00a2-423b-9567-55c6f4ee6ee1","administrator":"GECKOS!!","startDate":"2018-01-01T21:17:34.371Z","endDate":"2018-12-31T22:27:34.111Z","affiliations":[{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"111111","affiliateName":"test1"},{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"222222","affiliateName":"test2"}]}`
var administratorAffiliationMultiple_out2 = `{"docType":"ADMINISTRATORAFFILIATION","administratorAffiliationUUID":"817903a5-8a5f-4d51-af47-5bae33fc15b3","administrator":"GECKOS!!","startDate":"2018-01-01T21:17:34.371Z","endDate":"2018-12-31T22:27:34.111Z","affiliations":[{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"111111","affiliateName":"test1"},{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"222222","affiliateName":"test2"}]}`
...
func MockGetAdministratorAffiliationResponse(functionName string) []byte {
	...
	case "Test_GetAdministratorAffiliations":
		return []byte(`[{"docType":"ADMINISTRATORAFFILIATION","administratorAffiliationUUID":"85fff2bf-00a2-423b-9567-55c6f4ee6ee1","administrator":"GECKOS!!","startDate":"2018-01-01T21:17:34.371Z","endDate":"2018-12-31T22:27:34.111Z","affiliations":[{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"111111","affiliateName":"test1"},{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"222222","affiliateName":"test2"}]},{"docType":"ADMINISTRATORAFFILIATION","administratorAffiliationUUID":"817903a5-8a5f-4d51-af47-5bae33fc15b3","administrator":"GECKOS!!","startDate":"2018-01-01T21:17:34.371Z","endDate":"2018-12-31T22:27:34.111Z","affiliations":[{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"111111","affiliateName":"test1"},{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"222222","affiliateName":"test2"}]}]`)
	case "Test_GetAdministratorAffiliationByUUID":
		return []byte(`{"docType":"ADMINISTRATORAFFILIATION","administratorAffiliationUUID":"85fff2bf-00a2-423b-9567-55c6f4ee6ee1","administrator":"GECKOS!!","startDate":"2018-01-01T21:17:34.371Z","endDate":"2018-12-31T22:27:34.111Z","affiliations":[{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"111111","affiliateName":"test1"},{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"222222","affiliateName":"test2"}]}`)
...
func MockGetAdministratorAffiliationQueryResultForQueryString(stub shim.ChaincodeStubInterface, queryString string) ([]string, error) {
	if strings.Contains(queryString, "ADMINISTRATORAFFILIATION") {
		return []string{`{"docType":"ADMINISTRATORAFFILIATION","administratorAffiliationUUID":"85fff2bf-00a2-423b-9567-55c6f4ee6ee1","administrator":"GECKOS!!","startDate":"2018-01-01T21:17:34.371Z","endDate":"2018-12-31T22:27:34.111Z","affiliations":[{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"111111","affiliateName":"test1"},{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"222222","affiliateName":"test2"}]},{"docType":"ADMINISTRATORAFFILIATION","administratorAffiliationUUID":"817903a5-8a5f-4d51-af47-5bae33fc15b3","administrator":"GECKOS!!","startDate":"2018-01-01T21:17:34.371Z","endDate":"2018-12-31T22:27:34.111Z","affiliations":[{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"111111","affiliateName":"test1"},{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"222222","affiliateName":"test2"}]}`}, nil
	} else {
		return []string{`{"docType":"ADMINISTRATORAFFILIATION","administratorAffiliationUUID":"85fff2bf-00a2-423b-9567-55c6f4ee6ee1","administrator":"GECKOS!!","startDate":"2018-01-01T21:17:34.371Z","endDate":"2018-12-31T22:27:34.111Z","affiliations":[{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"111111","affiliateName":"test1"},{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"222222","affiliateName":"test2"}]},{"docType":"ADMINISTRATORAFFILIATION","administratorAffiliationUUID":"817903a5-8a5f-4d51-af47-5bae33fc15b3","administrator":"GECKOS!!","startDate":"2018-01-01T21:17:34.371Z","endDate":"2018-12-31T22:27:34.111Z","affiliations":[{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"111111","affiliateName":"test1"},{"selector":"Territory in ('AUS', 'USA', 'GBR')","affiliate":"222222","affiliateName":"test2"}]}`}, nil
	}
	return nil, nil
